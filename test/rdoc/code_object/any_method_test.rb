...
method(a, b) { |c, d| ... }
  ...
  def test_marshal_dump_version_5_round_trip
    @store.path = Dir.tmpdir
    top_level = @store.add_file 'file.rb'
  ...
  def test_marshal_load_v4_array_defaults_annotation_fields
    v4_array = [
      4, 'render', 'UI::Component#render', false, :public,
      RDoc::Markup::Document.new, nil, nil, [], nil, 'fake.rb', false,
      'Component', RDoc::NormalClass, 'top', nil, '() -> String'
    ]
    m = RDoc::AnyMethod.allocate
    m.marshal_load v4_array
    assert_equal ['() -> String'], m.type_signature_lines
    assert_equal false,            m.override
    assert_nil                     m.override_target
    assert_equal false,            m.abstract
  end
